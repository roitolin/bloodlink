...
export const parseTimestampToDate = (
  value: FirebaseLikeTimestamp | Date | string | number | null | undefined
): Date | null => {
...
export const getRequestSlaState = (
  request: { urgency?: string; createdAt?: any; slaDeadlineAt?: any; status?: string },
  now: Date = new Date()
): RequestSlaState => {
